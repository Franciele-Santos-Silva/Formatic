...
import 'package:formatic/services/profile_service.dart';
import 'package:formatic/models/user_profile.dart';
import 'package:flutter/services.dart';
import 'package:formatic/login_page.dart';
import 'dart:io';
import 'package:image_picker/image_picker.dart';
import 'package:formatic/widgets/button_styles.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _deleteProfileAndSignOut() async {
    if (_uid == null) return;
    setState(() => _loading = true);
    // capture navigator and messenger before async gaps to avoid using BuildContext across awaits
